...
public class ResultadosDAO {
	...
	public LinkedList<Tabela> quartas(String grupo) throws SQLException {
		
		CONEXAO = DBUtil.getInstance().getConnection();

		LinkedList<Tabela> classificados = new LinkedList<>();

		String sql = "SELECT TOP(2) * FROM fn_validagrupo(?) ORDER BY pontos DESC, vitorias DESC, golsMarcados DESC, saldoGols DESC";
