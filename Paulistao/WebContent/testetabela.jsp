...
<body>
	...
	<c:if test="${not empty tabelaGeral}">
		<div class="row">
			<table class="table table-striped table-dark" id="tabela">
				...
				<c:forEach items="${tabelaGeral}" var="t" varStatus="i">
					<tr>
						<c:if test="${i.count >= 17}">
							<tr bgcolor="#ffffff">
						</c:if>
						<td scope="row"><c:out value="${t.nomeTime}"></c:out></td>
						<td scope="row"><c:out value="${t.numJogosDisputados}"></c:out></td>
						<td scope="row"><c:out value="${t.vitorias}"></c:out></td>
						<td scope="row"><c:out value="${t.empates}"></c:out></td>
						<td scope="row"><c:out value="${t.derrotas}"></c:out></td>
						<td scope="row"><c:out value="${t.golsMarcados}"></c:out></td>
						<td scope="row"><c:out value="${t.golsSofridos}"></c:out></td>
						<td scope="row"><c:out value="${t.saldoGols}"></c:out></td>
						<td scope="row"><c:out value="${t.pontos}"></c:out></td>
					</tr>
				</c:forEach>
