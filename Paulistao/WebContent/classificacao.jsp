...
<body>
	...
	<div class="container">
		...
		LinkedList<Tabela> tabelaGeral = (LinkedList<Tabela>) session.getAttribute("TABELA_GERAL");
	...
	<%
		@SuppressWarnings("unchecked")
		LinkedList<Tabela> grupoA = (LinkedList<Tabela>) session.getAttribute("TABELA_A");
	...
	<%
		@SuppressWarnings("unchecked")
		LinkedList<Tabela> grupoB = (LinkedList<Tabela>) session.getAttribute("TABELA_B");
	...
	<%
		@SuppressWarnings("unchecked")
		LinkedList<Tabela> grupoC = (LinkedList<Tabela>) session.getAttribute("TABELA_C");
	...
	<%
		@SuppressWarnings("unchecked")
		LinkedList<Tabela> grupoD = (LinkedList<Tabela>) session.getAttribute("TABELA_D");
